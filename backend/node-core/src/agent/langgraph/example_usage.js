...
async function systemValidation(compatibilityLayer) {
    ...
    try {
        ...
        const rollbackId = await validationManager.createRollbackPoint(
            compatibilityLayer.agent.profile,
        ...
        const validationResult = await validationManager.validateSystem(
            compatibilityLayer.agent.profile,
            compatibilityLayer
        );
