...
import { AgentState, Goal, PersonalityTraits, SocialState } from '../langgraph/interfaces.js';

// ============================================================================
// COORDINATION STATE INTERFACES
// ============================================================================
...
export enum MessagePriority {
  ...
  BACKGROUND = 4    // Non-urgent updates
}
...
export enum BroadcastFrequency {
  ONCE = 'once',
  RECURRING = 'recurring',
...
export enum CollaborativeGoalStatus {
  PROPOSED = 'proposed',
  APPROVED = 'approved',
  ACTIVE = 'active',
  COMPLETED = 'completed',
...
// ============================================================================
// COORDINATION PERFORMANCE INTERFACES
// ============================================================================
...
// ============================================================================
// COORDINATION CONFIGURATION INTERFACES
// ============================================================================
...
// ============================================================================
// COORDINATION EVENTS INTERFACES
// ============================================================================
...
// ============================================================================
// COORDINATION REQUEST/RESPONSE INTERFACES
// ============================================================================
...
export enum LeadershipStructure {
  FLAT = 'flat',
  HIERARCHICAL = 'hierarchical',
  MATRIX = 'matrix',
  NETWORK = 'network',
