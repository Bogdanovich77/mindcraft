...
export class AntiIdleConfigManager {
  ...
  private presets: Map<string, AntiIdlePreset> = new Map();
  ...
  constructor(
    ...
    configPath?: string,
    initialConfig?: Partial<AntiIdleSystemConfig>
  ) {
   ...
   */
  private loadConfiguration(initialConfig?: Partial<AntiIdleSystemConfig>): AntiIdleSystemConfig {
    try {
   ...
   */
  private getDefaultConfig(): AntiIdleSystemConfig {
   ...
   */
  private createMinimalConfig(): AntiIdleSystemConfig {
    return {
      enabled: true,
      mode: 'balanced',
      goalGeneration: {
  ...
  autoAdjust(performanceMetrics: {
    ...
    const adjustments: Partial<AntiIdleSystemConfig> = {};
  ...
  private readConfigFile(path: string): string | null {
    try {
  ...
  private writeConfigFile(path: string, content: string): void {
    try {
