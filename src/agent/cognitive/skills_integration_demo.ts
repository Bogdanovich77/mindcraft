...
export class SkillsIntegrationDemo {
   ...
   * Demo 1: Basic Skill Progression
   */
  private async demoBasicSkillProgression(): Promise<void> {
    console.log('\n📈 Demo 1: Basic Skill Progression');
    console.log('----------------------------------------');
   ...
   * Demo 2: Personality-Influenced Learning
   */
  private async demoPersonalityInfluence(): Promise<void> {
    console.log('\n🧠 Demo 2: Personality-Influenced Learning');
    console.log('--------------------------------------------');
   ...
   * Demo 3: Skill Synergies
   */
  private async demoSkillSynergies(): Promise<void> {
    console.log('\n🔗 Demo 3: Skill Synergies');
    console.log('---------------------------');
    ...
    const primaryResult = this.learningEngine.processExperience(
      primarySkill,
      primaryEvent,
   ...
   * Demo 4: Integration with Purpose Core
   */
  private async demoPurposeCoreIntegration(): Promise<void> {
   ...
   * Demo 5: Goal-Driven Skill Development
   */
  private async demoGoalDrivenSkills(): Promise<void> {
    console.log('\n📋 Demo 5: Goal-Driven Skill Development');
    console.log('------------------------------------------');
    ...
    for (const { skill, goal, priority } of goalOrientedSkills) {
      ...
      const event = this.createExperienceEvent(
        skill, 
        Math.floor(40 * contextModifier), 
        ExperienceSource.PRACTICE, 
        `goal_driven_${goal}`
      );
   ...
   * Demo 6: Legacy System Bridge
   */
  private async demoLegacyBridge(): Promise<void> {
    console.log('\n🌉 Demo 6: Legacy System Bridge');
    console.log('---------------------------------');
   ...
   */
  private calculateTransferBonus(fromSkill: SkillType, toSkill: SkillType): number {
    // Simple transfer bonus calculation
    const transferMap: Partial<Record<SkillType, SkillType[]>> = {
   ...
   */
  private calculateSkillPersonalityAlignment(personality: any): Record<string, number> {
 ...
 */
export async function runSkillsIntegrationDemo(): Promise<void> {
