...
export class CompatibilityTests {
    ...
    async testValidationRollback() {
        ...
        results.push(await this.runTest('Rollback Manager - Rollback Point Creation', async () => {
            ...
            const rollbackId = await validationRollbackManager.createRollbackPoint(testData, 'Test rollback point', 'test_component');
            if (!rollbackId) {
...
//# sourceMappingURL=compatibility_tests.js.map