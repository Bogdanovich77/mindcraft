...
export class SocialPerformanceOptimizer {
     ...
     */
    async getCachedRelationship(targetAgentId, relationshipManager) {
     ...
     */
    async getCachedSearchResults(query, relationshipManager) {
        const startTime = Date.now();
        if (!this.config.enableCaching) {
     ...
     */
    queueRelationshipUpdate(targetAgentId, update, relationshipManager) {
     ...
     */
    async processBatch(relationshipManager) {
     ...
     */
    scheduleBatchProcessing(relationshipManager) {
        setTimeout(() => {
     ...
     */
    cacheRelationship(key, relationship) {
 ...
 */
export function getPerformanceOptimizer(config) {
    if (!globalOptimizer) {
...
//# sourceMappingURL=performance_optimizations.js.map