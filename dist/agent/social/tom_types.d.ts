 ...
 */
export declare enum SocialBeliefType {
 ...
 * Source of a belief
 */
export declare enum BeliefSource {
 ...
 * Types of intentions
 */
export declare enum IntentionType {
    SURVIVAL = "survival",
 ...
 */
export declare enum SituationType {
    COOPERATION = "cooperation",
    COMPETITION = "competition",
 ...
 * Power balance assessment
 */
export declare enum PowerBalance {
    BALANCED = "balanced",
    DOMINATED = "dominated",
 ...
 */
export declare enum CommunicationFlow {
 ...
 * Types of leadership
 */
export declare enum LeadershipType {
 ...
 */
export declare enum SubgroupRelationship {
 ...
 */
export declare enum ConflictLevel {
    NONE = "none",
    LOW = "low",
    MODERATE = "moderate",
    HIGH = "high",
 ...
 */
export declare enum ParticipationLevel {
    FULL = "full",
    MAJORITY = "majority",
    MINORITY = "minority",
    ELITE = "elite",
...
//# sourceMappingURL=tom_types.d.ts.map